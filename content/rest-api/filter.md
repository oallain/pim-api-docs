...
```
ch={"categories":[{"operator":"IN","value":["winter_collection"]}]}
```
...
```
/api/rest/v1/product-models?search={"categories":[{"operator":"IN","value":["winter_collection"]}],"completeness":[{"operator":"ALL COMPLETE","locales":["en_US"],"scope":"ecommerce"}]}
```
